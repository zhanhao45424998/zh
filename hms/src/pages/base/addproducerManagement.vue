<template>
   <div class="addproducerManagement">
       <div>
           <Head title="生产企业基本信息">
                     <div>
            ...
            <div>
                 <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm">
                    <div class="borderstyle clearfix">
                        <el-col :span="11">
                    ...
                    <div class="borderstyle clearfix">
                        <el-col :span="11">
                            <el-form-item label="所属地区 : " prop="name">
                                <el-cascader :options="options" placeholder="请选择" class="item-css" v-model="ruleForm.ast"></el-cascader>
                            </el-form-item>     
                        </el-col>
                        <el-col :span="11">
                            <el-form-item label="具体联系地址：">
                                <el-input v-model="ruleForm.names" placeholder="具体联系地址"></el-input>
                            </el-form-item>
                        </el-col>      
                    </div>
                 </el-form>    
...
export default {
  ...
  data(){
    return{
        ...
        tableData:[
            {type:'营业执照',state:'正常',msg:"信息正常",psd:'as1093292837392',time:"永久有效"}
        ],
         options: [{
            value: 'jiangsusheng',
            label: '江苏省',

<template>
   <div class="editdistribution">
        <div>
            ...
            <div>
                <el-form ref="form" :model="forms" :rules="rules" label-width="130px">
                    <div class="liststyle" >
                        <el-form-item label="库房:"  prop="name">
                            <el-input v-model="forms.names" :disabled="true"></el-input>
                        </el-form-item>
                    </div>  
                    <div class="liststyle" >
                        <el-form-item label="企业名称:">
                            <el-input v-model="forms.name" style=""></el-input>
                        </el-form-item>

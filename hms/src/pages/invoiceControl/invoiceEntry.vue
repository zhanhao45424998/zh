      ...
      <div class="firstInput">
        ...
        <div class="formTitleLine" ref="print" id="printMe">
          ...
          >
            ...
            <el-form-item label="子库房:" prop="name">
              <el-select
                v-model="value2"
                filterable
                :filter-method="choose"
            ...
            <el-form-item label="是否寄存:" prop="name">
              <el-select
                v-model="value6"
                filterable
                :filter-method="choose"
       ...
       <div class="second">
        <el-form ref="form" :model="form">
          <el-form-item label="搜索:" label-width="100px">
            ...
            <el-button type="primary" icon="el-icon-plus" class="showbutton">录入数据</el-button>

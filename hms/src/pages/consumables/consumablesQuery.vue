<template>
   <div class="consumablesQuery">
       <div class="consumablesQuery-title">
            ...
            <HeadSearch>       
                    ...
                    <template v-slot:anniu>
                        <el-button type="primary"> 汇总查询</el-button>
                        <el-button type="success"> 明细查询</el-button>
                    </template>                
            </HeadSearch>
       </div>
       <div class="consumablesQuery-list">
            <Heads title="产品列表">
                <el-button type="success" >更多操作</el-button>
            </Heads>
            ...
            <el-table
               ...
               >
                ...
                <template slot-scope="scope">
                    ...
                    size="mini"
                    type="warning"
                    @click="handleDelete(scope.$index, scope.row)">变更</el-button>
                </template>
                </el-table-column>
            </el-table>
...
export default {
  name: '',
  components:{ Head,HeadSearch,Heads},  
  data(){
    return{
        tableData3: [
            {

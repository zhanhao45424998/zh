        ...
        >
          ...
          <el-form-item label="查询方式：">
            <el-radio-group v-model="form.resource">
              <el-radio label="按入库汇总"></el-radio>
              <el-radio label="按发票汇总"></el-radio>
              <el-radio label="按捐赠汇总"></el-radio>
              <el-radio label="按一级类别汇总"></el-radio>
              <el-radio label="按末级类别汇总"></el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item>

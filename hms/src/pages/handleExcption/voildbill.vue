    ...
    <div class="first">
      ...
      <div class="firstInput">
        <el-form ref="form" :model="form" label-width="280px" :rules="rules" :inline="true">
          <el-form-item label="请输入住院(门诊)号:" prop="name">
            <el-input v-model="form.name" placeholder="请输入住院(门诊)号"></el-input>
          </el-form-item>
          <el-form-item label="请输入住院(门诊)号:" prop="resource">
            <el-input v-model="form.name" placeholder="请输入住院(门诊)号"></el-input>
          </el-form-item>
        </el-form>
      </div>
    ...
    <div class="second">
      <div class="secondTitle">
        <el-row>
          ...
          <el-col :span="3">
            <el-button type="primary" icon="el-icon-close">作废验货单</el-button>
          </el-col>
        </el-row>
      </div>
      <div>
        ...
        >
          ...
          <el-table-column prop="name" label="耗材规格" width="220" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="name" label="待配送数量" width="220" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="name" label="单价" width="220" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="address" width="220" label="金额" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="address" width="220" label="交易码" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="address" width="220" label="失效效期" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="address" width="220" label="生产日期" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="address" width="220" label="产品唯一码" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>{{ scope.row.date }}</div>
            </template>
          </el-table-column>
...
export default {
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: "验收流水号", trigger: "blur" }],
